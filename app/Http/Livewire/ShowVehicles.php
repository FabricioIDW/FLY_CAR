...
class ShowVehicles extends Component
{
    ...
    {
        $vehiculos = Vehicle::select('vehicles.id', 'vehicles.chassis', 'brands.name as nombreMarca', 'vehicle_models.name as nombreModelo', 'vehicles.vehicle_model_id', 'vehicle_models.brand_id')->join('vehicle_models', 'vehicle_models.id', '=', 'vehicles.vehicle_model_id')
