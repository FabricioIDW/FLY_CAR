...
<body class="bg-blue-50">
    <div class="m-4">
        <div class="credit-card w-full sm:w-auto shadow-lg mx-auto rounded-xl bg-white" x-data="creditCard">
            ...
            <main class="mt-4 p-4">
                <h1 class="text-xl font-semibold text-gray-700 text-center">Tarjeta de pago</h1>
                <form action="{{ route('payments.store') }}" method="POST" x-ref="paymentForm">
                    @csrf
                    <div class="">
                        <div class="my-3">
                        ...
                        <div class="my-3">
                            <input type="text" name="cardNumber"
                                class="block w-full px-5 py-2 border rounded-lg bg-white shadow-lg placeholder-gray-400 text-gray-700 focus:ring focus:outline-none"
                                placeholder="Número de tarjeta" x-model="cardNumber" x-on:keydown="format()"
                                x-on:keyup="isValid()" maxlength="19" />
                        </div>
                        <div class="my-3 flex flex-col">
                            <div class="mb-2">
                                <label for="" class="text-gray-700">Fecha de vencimiento</label>
                            </div>
                            <div class="grid grid-cols-2 sm:grid-cols-4 gap-2">
                                <select name="expiredMonth" id=""
                                ...
                                <input type="text" name="securityCode"
                                    ...
                                    placeholder="Código de seguridad" maxlength="3" x-model="securityCode"
            ...
            <input type="hidden" name="accepted" value="false" x-ref="accepted">
