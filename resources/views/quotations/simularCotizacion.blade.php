...
@section('content')
    ...
    <div class="bg-black-400 col-span-1 lg:col-span-2 row-span-2 rounded-b-lg">
      ...
      <p class="">
       <span class="text-xl font-bold">Año: {{$vehiculo->year}}</span> 
       <br>
       <span class="text-xl font-bold">Marca: {{$vehiculo->vehicleModel->brand->name}}</span>
       <br>
       <span class="text-xl font-bold">Modelo: {{$vehiculo->vehicleModel->name}}</span> 
       <br>
       <span class="text-xl font-bold">Descripcion: {{$vehiculo->description}}</span> 
       <br>
      </p>
